...
define(['N/record', 'N/render', 'N/log'], function(record, render, log) {
    ...
    function onRequest(context) {
        if (context.request.method === 'GET') {
            ...
            if (!recordId) {
                context.response.write('Intercompany Transfer Order ID parameter is missing.');
                return;
            }

            try {
                // Load Intercompany Transfer Order record
                ...
                pdfContent += '<td></td>';
                pdfContent += '<td></td>';
                pdfContent += '<td><strong>Intercompany Transfer Order #</strong></td>';
